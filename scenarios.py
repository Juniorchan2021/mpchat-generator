...
SCENARIO_CATEGORIES = {
    "🤖 AI 工具订阅": [
        ...
        {
            "label": "用USDT订阅Claude Pro",
            "audience_tag": "AI工具用户",
            "keywords": "USDT订阅Claude, 加密货币Claude Pro, MP Card AI订阅, Anthropic Claude",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["artificial intelligence", "machine learning"],
        },
        {
            "label": "用USDT订阅Midjourney",
            "audience_tag": "AI设计师",
            "keywords": "USDT订阅Midjourney, 加密货币AI绘画, MP Card Midjourney, 虚拟卡AI工具",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["digital art", "creative design"],
        },
        {
            "label": "用USDT订阅Cursor Pro",
            "audience_tag": "开发者",
            "keywords": "USDT订阅Cursor, 加密货币Cursor Pro, MP Card开发工具, AI编程助手",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["programming code", "software development"],
        },
        {
            "label": "用USDT充值OpenAI API",
            "audience_tag": "开发者",
            "keywords": "USDT充值OpenAI, 加密货币API额度, MP Card OpenAI, 虚拟卡API",
            "selling_points": ["virtual_card", "instant_settlement", "multi_currency"],
            "style_hint": "tutorial",
            "pixabay_terms": ["cloud computing", "api technology"],
        },
        {
            "label": "用USDT订阅Adobe Firefly",
            "audience_tag": "创意设计师",
            "keywords": "USDT订阅Adobe, 加密货币Firefly, MP Card Adobe, 虚拟卡创意工具",
            "selling_points": ["virtual_card", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["graphic design", "creative tools"],
        },
        {
            "label": "用USDT订阅Pika/Sora视频AI",
            "audience_tag": "视频创作者",
            "keywords": "USDT订阅Pika, 加密货币Sora, MP Card视频AI, AI视频生成",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["video production", "creative media"],
        },
    ],
    "🎬 流媒体与娱乐": [
        {
            "label": "用USDT订阅Netflix",
            "audience_tag": "流媒体用户",
            "keywords": "USDT充值Netflix, 加密货币订阅Netflix, 虚拟卡流媒体, 海外追剧",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["streaming entertainment", "movie night"],
        },
        {
            "label": "用USDT订阅Spotify Premium",
            "audience_tag": "音乐爱好者",
            "keywords": "USDT充值Spotify, 加密货币订阅音乐, MP Card Spotify, 虚拟卡音乐",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["music headphones", "spotify playlist"],
        },
        {
            "label": "用USDT订阅YouTube Premium",
            "audience_tag": "视频爱好者",
            "keywords": "USDT充值YouTube, 加密货币YouTube Premium, MP Card YouTube, 去广告",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["video streaming", "youtube content"],
        },
        {
            "label": "用USDT订阅Disney+",
            "audience_tag": "家庭用户",
            "keywords": "USDT订阅Disney, 加密货币Disney Plus, MP Card Disney, 虚拟卡娱乐",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["family entertainment", "movie theater"],
        },
        {
            "label": "用USDT订阅HBO Max",
            "audience_tag": "美剧爱好者",
            "keywords": "USDT订阅HBO, 加密货币HBO Max, MP Card HBO, 虚拟卡追剧",
            "selling_points": ["virtual_card", "instant_settlement"],
            "style_hint": "tutorial",
            "pixabay_terms": ["tv series", "home cinema"],
        },
        {
    ...
    "🛠️ 开发者工具": [
        ...
        {
            "label": "用USDT订阅GitHub Copilot",
            "audience_tag": "开发者",
            "keywords": "USDT订阅Copilot, 加密货币GitHub, MP Card编程工具, AI代码助手",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["github code", "developer workspace"],
        },
        {
            "label": "用USDT注册Google Play Developer",
            "audience_tag": "Android开发者",
            "keywords": "USDT注册Google Play, 加密货币开发者账号, MP Card Google, 虚拟卡注册",
            "selling_points": ["virtual_card", "instant_settlement"],
            "style_hint": "tutorial",
            "pixabay_terms": ["android development", "mobile app"],
        },
        {
            "label": "用USDT订阅Vercel/Cloudflare Pro",
            "audience_tag": "全栈开发者",
            "keywords": "USDT订阅Vercel, 加密货币Cloudflare, MP Card云服务, 虚拟卡部署",
            "selling_points": ["virtual_card", "subscription_mgmt", "multi_currency"],
            "style_hint": "tutorial",
            "pixabay_terms": ["cloud server", "web hosting"],
        },
        {
            "label": "用USDT购买域名与云服务",
            "audience_tag": "站长/开发者",
            "keywords": "USDT买域名, 加密货币云服务, MP Card域名, 虚拟卡Namecheap",
            "selling_points": ["virtual_card", "instant_settlement", "multi_currency"],
            "style_hint": "tutorial",
            "pixabay_terms": ["domain hosting", "internet website"],
        },
    ],
    "💼 生产力工具": [
        {
            "label": "用USDT订阅Notion Plus",
            "audience_tag": "知识工作者",
            "keywords": "USDT订阅Notion, 加密货币Notion, MP Card生产力工具, 虚拟卡笔记",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["productivity workspace", "note taking"],
        },
        {
            "label": "用USDT订阅Canva Pro",
            "audience_tag": "设计师/营销",
            "keywords": "USDT订阅Canva, 加密货币设计工具, MP Card Canva, 虚拟卡创意",
            "selling_points": ["virtual_card", "instant_settlement", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["graphic design", "creative canvas"],
        },
        {
            "label": "用USDT订阅Figma Pro",
            "audience_tag": "UI/UX设计师",
            "keywords": "USDT订阅Figma, 加密货币设计, MP Card Figma, 虚拟卡UI工具",
            "selling_points": ["virtual_card", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["user interface design", "ux prototype"],
        },
        {
            "label": "用USDT订阅Grammarly Premium",
            "audience_tag": "写作者/留学生",
            "keywords": "USDT订阅Grammarly, 加密货币写作工具, MP Card Grammarly, 虚拟卡英语",
            "selling_points": ["virtual_card", "instant_settlement"],
            "style_hint": "tutorial",
            "pixabay_terms": ["writing tools", "english learning"],
        },
        {
            "label": "用USDT订阅Zoom/Google Workspace",
            "audience_tag": "远程工作者",
            "keywords": "USDT订阅Zoom, 加密货币Google Workspace, MP Card办公, 虚拟卡会议",
            "selling_points": ["virtual_card", "subscription_mgmt", "multi_currency"],
            "style_hint": "tutorial",
            "pixabay_terms": ["video conference", "remote work"],
        },
    ],
    "📢 社交媒体推广": [
        {
            "label": "用USDT投放Twitter/X广告",
            "audience_tag": "社交媒体营销者",
            "keywords": "USDT投放Twitter广告, 加密货币X广告, MP Card社交推广, 虚拟卡广告",
            "selling_points": ["virtual_card", "instant_settlement", "multi_currency"],
            "style_hint": "tutorial",
            "pixabay_terms": ["social media marketing", "twitter advertisement"],
        },
        {
            "label": "用USDT投放Facebook/Instagram广告",
            "audience_tag": "电商营销者",
            "keywords": "USDT投放Facebook广告, 加密货币Meta广告, MP Card营销, 虚拟卡广告",
            "selling_points": ["virtual_card", "instant_settlement", "multi_currency"],
            "style_hint": "tutorial",
            "pixabay_terms": ["facebook marketing", "social media ads"],
        },
        {
            "label": "用USDT订阅LinkedIn Premium",
            "audience_tag": "职场人士",
            "keywords": "USDT订阅LinkedIn, 加密货币LinkedIn Premium, MP Card职场, 虚拟卡",
            "selling_points": ["virtual_card", "subscription_mgmt"],
            "style_hint": "tutorial",
            "pixabay_terms": ["professional networking", "business meeting"],
        },
        {
            "label": "用USDT订阅TikTok商业工具",
            "audience_tag": "短视频创作者",
            "keywords": "USDT订阅TikTok, 加密货币TikTok推广, MP Card短视频, 虚拟卡TikTok",
            "selling_points": ["virtual_card", "instant_settlement"],
            "style_hint": "tutorial",
            "pixabay_terms": ["tiktok video", "short video content"],
        },
    ],
    "🌍 跨境支付与收款": [
        {
